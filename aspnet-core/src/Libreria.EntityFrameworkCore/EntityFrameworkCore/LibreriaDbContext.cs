...
public class LibreriaDbContext :
    AbpDbContext<LibreriaDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(LibreriaConsts.DbTablePrefix + "YourEntities", LibreriaConsts.DbSchema);
        //    b.ConfigureByConvention(); //auto configure for the base class props
        //    //...
        //});
        builder.Entity<Book>(b =>
        {
            b.ToTable(LibreriaConsts.DbTablePrefix + "Books", LibreriaConsts.DbSchema);
